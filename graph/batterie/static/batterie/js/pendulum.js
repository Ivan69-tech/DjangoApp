$('#set_variables_form').submit(function (e) {
  ...
  time   = $('#time').val();
  l1     = $('#longueur').val()*0.01*2*long/4
  l2     = (1-$('#longueur').val()*0.01)*2*long/4
  d2Phi1 = 0;
  d2Phi2 = 0;
  dPhi1  = 0;
  dPhi2  = 0;
...
var colH    = $('#Pendulum').height();
var colL    = $('#Pendulum').width();

var long    = Math.min(colH, colL);
context.canvas.height = long;
context.canvas.width = long;
